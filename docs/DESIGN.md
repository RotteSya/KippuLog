...
| timeline pinch | the pinch holds the fold itself (ShelfFold): the issue lays back on its bottom hinge — its own opaque sheet of paper, dipping into shadow — and the 収蔵帳 is simply *uncovered* beneath, top-first; release carries the SAME fold through the commit spring. The two shelves never crossfade. The colophon whispers the way in |
| timeline ⇄ 収蔵帳 | one continuous fold both ways — pinch, corner doors, and month stamps all drive the same engine; the月 jump scrolls under the still-folded page so the reveal opens onto the month |
